...
| `impedance-doc` | Render per-copper-layer controlled-impedance routing documentation (differential + single-ended) to SVG/HTML/PNG/PDF, driven by a commented JSONC config. | Public |
