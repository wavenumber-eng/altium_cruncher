# Altium Cruncher Plans

This folder tracks active and useful planning material for `altium_cruncher`.

Active plans:

- `PUBLIC_REPO_MIGRATION_PLAN.md` - migration of `altium_cruncher` from the
  private `toolz` monorepo into the standalone public repository.
...
rewritten as public design docs and contract tests.
