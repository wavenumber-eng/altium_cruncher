...
def test_easyeda_import_is_not_optional_extra_placeholder() -> None:
    """EasyEDA commands should be available in the base package install."""
    assert importlib.util.find_spec("easyeda_monkey") is not None
    assert [
        entry
