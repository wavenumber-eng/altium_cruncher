...
from .mate_config_fields import (
    _optional_section as _optional_section,
    _section as _section,
    _json_object as _json_object,
    _optional_string as _optional_string,
    _number_like as _number_like,
    _target_float as _target_float,
    _target_optional_string as _target_optional_string,
    _style_string as _style_string,
    _style_string_or_int as _style_string_or_int,
    _style_bool as _style_bool,
    _style_float as _style_float,
    _part_string as _part_string,
    _part_optional_string as _part_optional_string,
    _safe_id as _safe_id,
    _resolve_config_path as _resolve_config_path,
    _optional_bool as _optional_bool,
    _optional_float as _optional_float,
    _optional_float_or_none as _optional_float_or_none,
    _required_point as _required_point,
    _optional_point as _optional_point,
    _point_number as _point_number,
    _optional_number_object as _optional_number_object,
    _number_field as _number_field,
)
...
from altium_cruncher import altium_cruncher_mate_templates as mate_tpl
...
def parse_mate_config(
    ...
    *,
    ...
    from .contracts.workflows import decode_mate_config

    root = decode_mate_config(root)
...
def build_mate_seed_config(
    ...
    *,
    ...
    return {
        ...
        "projections": mate_tpl.mate_seed_projections(inspection),
...
def _projection_reference_graphics_config(
    ...
    if _projection_requests_mate_component(projection):
        return mate_tpl.default_mate_reference_graphics_payload()
    return None
