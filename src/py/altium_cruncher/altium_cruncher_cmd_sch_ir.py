...
from .schematic_diagnostics import (
    _font_diagnostics_from_ir_payload as _font_diagnostics_from_ir_payload,
    _log_font_diagnostics as _log_font_diagnostics,
    log_current_font_resolution_diagnostics as log_current_font_resolution_diagnostics,
)
