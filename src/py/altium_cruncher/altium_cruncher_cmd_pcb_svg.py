...
def _default_pcb_svg_config_text(
    ...
    *,
    ...
    return (
        ...
        "                 For true profile-only output, set include_visible=false and include_outline=true.\n"
        ...
        "\n"
        "The default pin-1 views use simple HLR plus include_visible=false and\n"
        "include_outline=true so they show the outside profile without internal edges.\n"
        "\n"
