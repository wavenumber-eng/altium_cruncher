    ...
    if (data.bodies !== void 0) {
      ...
      if (Array.isArray(data11)) {
        ...
        for (let i3 = 0; i3 < len3; i3++) {
          if (!validate23(data11[i3], { instancePath: instancePath + "/bodies/" + i3, parentData: data11, parentDataProperty: i3, rootData, dynamicAnchors })) {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.instances !== void 0) {
      ...
      if (Array.isArray(data3)) {
        ...
        for (let i0 = 0; i0 < len0; i0++) {
          if (!validate22(data3[i0], { instancePath: instancePath + "/instances/" + i0, parentData: data3, parentDataProperty: i0, rootData, dynamicAnchors })) {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.layers !== void 0) {
      ...
      if (Array.isArray(data2)) {
        ...
        for (let i0 = 0; i0 < len0; i0++) {
          if (!validate21(data2[i0], { instancePath: instancePath + "/layers/" + i0, parentData: data2, parentDataProperty: i0, rootData, dynamicAnchors })) {
